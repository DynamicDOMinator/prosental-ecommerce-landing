...
export default function FeaturesSection() {
  const offerItems = [
    ...
    },
    {
      ...
      description:
        "متجرك ملك لك بالكامل، تدفع فقط ثمن الاستضافة، ولا توجد أي رسوم إضافية (0%).",
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-20 max-w-4xl mx-auto">
          <h2 className="text-4xl md:text-7xl font-black mb-6 leading-tight">
            ماذا{" "}
            <span className="text-primary-500 text-shadow-primary">
              ستحصل علي؟
            </span>
          </h2>
          <p className="text-slate-400 text-xl md:text-2xl leading-relaxed max-w-3xl mx-auto font-medium">
            باقة متكاملة تضمن لك النجاح من اليوم الأول، بدون تعقيدات تقنية.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="space-y-12 text-center">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-400 text-xl md:text-2xl max-w-2xl mx-auto leading-relaxed font-medium">
                  فيديو يشرح كيفية إعداد متجرك مع شرح كل ميزة مدمجة بالتفصيل
                  الممل.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-400 text-xl md:text-2xl max-w-2xl mx-auto leading-relaxed font-medium">
                  متجرك ملكك بالكامل، تدفع فقط ثمن الاستضافة، ولا توجد أي رسوم
                  إضافية (0%).
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-12 relative z-10">
                ...
                <div className="pt-8 border-t border-slate-800 lg:mr-13 flex flex-col md:flex-row items-center md:items-start gap-6">
                  ...
                  <div className="space-y-2">
                    <h4 className="text-2xl md:text-3xl font-black text-white">
                      جلسة استراتيجية (60 دقيقة)
                    </h4>
                    <p className="text-slate-400 text-xl leading-relaxed">
                      سنساعدك على زيادة أرباحك من خلال تخصيص متجرك باستخدام
                      مميزاتنا المتقدمة مثل العروض المجمعة، الإضافات، والمنتجات
                      المقترحة.
                    </p>
                  </div>
                </div>
              ...
              <div className=" flex flex-col md:flex-row items-center justify-between gap-8 bg-slate-950/80 p-3 rounded-2xl border-2 border-primary-500/40 shadow-2xl backdrop-blur-xl group-hover:border-primary-500/60 transition-all">
                <div className="text-center md:text-right">
                  <p className="text-slate-500 text-lg font-black uppercase tracking-[0.2em] mb-2">
                    القيمة الإجمالية لهذه الإضافات
                  </p>
                  <h4 className="text-2xl md:text-3xl font-black text-white">
                    إعداد المتجر + جلسة استراتيجية
                  </h4>
                </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-10 px-8">
            <button
              ...
              className="text-3xl md:text-4xl font-black text-white hover:text-primary-500 transition-all flex items-center gap-4 group underline decoration-primary-500/30 underline-offset-16 decoration-8 cursor-pointer"
            >
              احجز موعداً لشراء متجرك
              ...
              <div className="text-right">
                <div className="flex items-center gap-6 dir-rtl">
                  ...
                  <div className="flex flex-col italic">
                    ...
                    <span className="text-2xl font-bold text-slate-500 line-through decoration-red-500/60 decoration-8">
                      10,000
                    </span>
                  </div>
                </div>
