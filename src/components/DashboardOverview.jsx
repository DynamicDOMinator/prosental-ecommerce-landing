      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="relative mt-20">
          <div className="w-full relative overflow-x-auto hide-scrollbar pb-16 md:pb-8 pt-12 md:pt-16 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden flex snap-x snap-mandatory">
            <div 
              className="flex flex-row lg:gap-30 items-center lg:justify-center w-max min-w-full before:content-[''] after:content-[''] before:m-auto after:m-auto before:hidden lg:before:block after:hidden lg:after:block before:min-w-[4rem] lg:before:min-w-[14rem] after:min-w-[4rem] lg:after:min-w-[14rem]"
            >
              {/* Phone Mockup 1 (Slide 1) */}
              <div className="w-[100vw] sm:w-[500px] lg:w-auto flex justify-center shrink-0 snap-center lg:pl-12 pt-8 pb-[500px] md:pb-8">
                <div className="relative w-[280px] h-[580px]">
                 {/* Annotation 1: Analyses (Top-Right) */}
                 <div className="absolute left-1/2 -translate-x-1/2 md:translate-x-0 md:left-auto md:-right-44 top-[600px] md:top-6 z-30 pointer-events-none w-64">
                    <div className="bg-white border-[3px] border-[#10b981] p-3 md:p-4 rounded-[1.5rem] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-right transform rotate-2">
                 ...
                 {/* Annotation 2: Pro Features (Middle-Right) */}
                 <div className="absolute left-1/2 -translate-x-1/2 md:translate-x-0 md:left-auto md:-right-44 top-[720px] md:top-1/2 md:-translate-y-1/2 z-30 pointer-events-none w-64 md:w-72">
                    <div className="bg-white border-[3px] border-[#10b981] p-3 md:p-4 rounded-[1.5rem] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-right transform -rotate-2">
                 ...
                 {/* Annotation 3: Total Control (Bottom-Right) */}
                 <div className="absolute left-1/2 -translate-x-1/2 md:translate-x-0 md:left-auto md:-right-44 top-[840px] md:bottom-12 md:top-auto z-30 pointer-events-none w-64 md:w-72">
                    <div className="bg-white border-[3px] border-[#10b981] p-3 md:p-4 rounded-[1.5rem] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-right transform rotate-1">
              ...
              <div className="w-[100vw] sm:w-[500px] lg:w-auto flex justify-center shrink-0 snap-center lg:pr-12 pt-8 pb-[380px] md:pb-8">
                <div className="relative w-[280px] h-[580px]">
                 {/* Annotation 4: Discount Codes (Top-Left) */}
                 <div className="absolute left-1/2 -translate-x-1/2 md:translate-x-0 md:right-auto md:-left-44 top-[600px] md:top-20 z-30 pointer-events-none w-64">
                    <div className="bg-white border-[3px] border-[#10b981] p-3 md:p-4 rounded-[1.5rem] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-right transform -rotate-1">
                 ...
                 {/* Annotation 5: Admin Management (Bottom-Left) */}
                 <div className="absolute left-1/2 -translate-x-1/2 md:translate-x-0 md:right-auto md:-left-44 top-[720px] md:bottom-28 md:top-auto z-30 pointer-events-none w-64 md:w-72">
                    <div className="bg-white border-[3px] border-[#10b981] p-3 md:p-4 rounded-[1.5rem] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-right transform rotate-2">
